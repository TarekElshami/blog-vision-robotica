# Máster U. en Visión Artificial: Memorias de Prácticas
**Autor:** Tarek Elshami Ahmed

Este repositorio contiene las memorias detalladas de las prácticas realizadas en la asignatura de **Visión Robótica**. Cada práctica incluye la explicación del algoritmo, lógica de control y resultados obtenidos.
